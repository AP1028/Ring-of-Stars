...
16. <span id="反物质推进器">**反物质推进器**</span>
    1. **π介子工质推进型**(*I<sub>sp</sub>=0.30c/g*)
...
1. **星系级“种子”文明扩展装置**(一个被派往其他星系的机器，目的在于从零开始在这个星系中的所有恒星系建造多[戴森球](#戴森壳)、[恒星级拖船](#恒星级拖船)等设施，并通过这些设施建造[星系级飞船](#星系级飞船)，最后自我复制飞往更多临近星系重复这个过程)
